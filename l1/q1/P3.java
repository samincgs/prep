...
public class P3 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("P3 is waiting for a connection...");

            // Accept the connection
            Socket socket = serverSocket.accept();
            System.out.println("P3: Connection accepted");
            ...
            // Append "-I am P3" to the message
            String modifiedMessage = message + "-I am P3";
